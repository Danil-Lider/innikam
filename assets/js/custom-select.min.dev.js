...
(function () {
  ...
  1: [function (require, module, exports) {
    try {
      ...
      var CustomEvent = function CustomEvent(e, t) {
        var n, r;
        return t = t || {
          bubbles: !1,
          cancelable: !1,
  ...
  3: [function (require, module, exports) {
    ...
    function builder(e, t) {
      ...
      function C(e, t, n) {
        ...
        if (t) for (var a = 0, r = o.length; a < r; a++) {
          s === N ? S.appendChild(o[a]) : s.customSelectOriginalOptgroup.appendChild(o[a]);
        }
      ...
      function h() {
        for (var e = []; S.children.length;) {
          N.removeChild(N.children[0]), e.push(S.removeChild(S.children[0]));
        }
      ...
      function O() {
        ...
        for (var n = S.getElementsByTagName("optgroup"), s = 0, o = n.length; s < o; s++) {
      ...
      for (var H = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789", U = 0; U < 5; U++) {
    ...
    function customSelect(e, t) {
      var n = [],
          s = [];
      return function () {
        if (e && e instanceof HTMLElement && "SELECT" === e.tagName.toUpperCase()) n.push(e);else if (e && "string" == typeof e) for (var o = document.querySelectorAll(e), a = 0, r = o.length; a < r; ++a) {
          o[a] instanceof HTMLElement && "SELECT" === o[a].tagName.toUpperCase() && n.push(o[a]);
        } else if (e && e.length) for (var i = 0, c = e.length; i < c; ++i) {
          e[i] instanceof HTMLElement && "SELECT" === e[i].tagName.toUpperCase() && n.push(e[i]);
        }
